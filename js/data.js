...
//table-1
{
    ...
    weight: "16 kg",
    description: "A sturdy dark wood coffee table with a timeless rustic look, perfect for cozy living spaces.",
    rating: 4.4,
    ratingCount: 18,
    images: [
...
//table-2
{
    ...
    weight: "20 kg",
    description: "A functional coffee table featuring hidden storage compartments to keep your space organized.",
    rating: 4.6,
    ratingCount: 25,
    images: [
...
//table-3
{
    ...
    weight: "14 kg",
    description: "A sleek and modern coffee table with a lower shelf for extra storage and display.",
    rating: 4.3,
    ratingCount: 14,
    images: [
...
//table-4
{
    ...
    weight: "17 kg",
    description: "A modern coffee table crafted with a warm oak finish, ideal for contemporary interiors.",
    rating: 4.5,
    ratingCount: 20,
    images: [
...
//table-5
{
    ...
    weight: "15 kg",
    description: "A practical coffee table with an open shelf design, perfect for books and decor display.",
    rating: 4.2,
    ratingCount: 11,
    images: [
...
//table-6
{
    ...
    weight: "19 kg",
    description: "A versatile lift-top coffee table with hidden storage, ideal for compact and multifunctional spaces.",
    rating: 4.7,
    ratingCount: 32,
    images: [
...
//shelf-1
{
    ...
    weight: "4 kg",
    description: "A rustic wall shelf set with sturdy J brackets, perfect for decorative displays and everyday storage.",
    rating: 4.5,
    ratingCount: 21,
    images: [
...
//shelf-2
{
    ...
    weight: "3 kg",
    description: "A floating oak wall shelf with a clean and minimal profile, ideal for books, candles, and decor accents.",
    rating: 4.3,
    ratingCount: 16,
    images: [
...
//shelf-3
{
    ...
    weight: "6 kg",
    description: "A modern display shelf designed to showcase plants, framed prints, and decorative objects in style.",
    rating: 4.4,
    ratingCount: 19,
    images: [
...
//shelf-4
{
    ...
    weight: "7 kg",
    description: "A compact corner shelf that makes smart use of unused space while adding extra storage and display room.",
    rating: 4.2,
    ratingCount: 13,
    images: [
...
//shelf-5
{
    ...
    weight: "10 kg",
    description: "A warm wood ladder shelf with an open and airy design, great for displaying books, baskets, and plants.",
    rating: 4.6,
    ratingCount: 24,
    images: [
...
//shelf-6
{
    ...
    weight: "4.5 kg",
    description: "A sturdy wall shelf with metal brackets that blends rustic wood tones with a subtle industrial look.",
    rating: 4.1,
    ratingCount: 10,
    images: [
...
//accessory-1
{
    ...
    weight: "3.5 kg",
    description: "A tall wooden plant vase with a bold dark finish, perfect for statement greenery in any room.",
    rating: 4.5,
    ratingCount: 17,
    images: [
...
//accessory-2
{
    ...
    weight: "0.8 kg",
    description: "A set of durable wooden coasters designed to protect surfaces while adding a warm, natural touch.",
    rating: 4.3,
    ratingCount: 22,
    images: [
...
//accessory-3
{
    ...
    weight: "1.2 kg",
    description: "A set of small decorative vases in a light wood finish, ideal for minimalist table styling.",
    rating: 4.4,
    ratingCount: 15,
    images: [
...
//accessory-4
{
    ...
    weight: "1 kg",
    description: "A charming set of wooden duck accent pieces that add a playful and artistic touch to your space.",
    rating: 4.2,
    ratingCount: 11,
    images: [
...
//accessory-5
{
    ...
    weight: "1.5 kg",
    description: "A warm-toned decorative wood accent piece that brings texture and character to any room.",
    rating: 4.1,
    ratingCount: 9,
    images: [
...
//accessory-6
{
    ...
    weight: "2.2 kg",
    description: "A natural tree slice decorative centerpiece that highlights the beauty of raw wood grain.",
    rating: 4.6,
    ratingCount: 20,
    images: [
