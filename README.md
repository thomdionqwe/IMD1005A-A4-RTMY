...
### 🟢 Vue.js Integration (Bonus Feature)

- Integrated Vue.js to render the entire product listing section, including:
- Dynamic category grouping (Tables, Shelves, Accessories)
- Reactive product rendering using v-for
- Replaced manual DOM manipulation with Vue’s reactive data binding, improving performance and maintainability
- This Vue component demonstrates meaningful use of reactivity and modern frontend patterns

### 🤖 AI‑Supported Development

- AI tools were used as a reference for Vue.js concepts and example patterns. The final code, structure, and logic were written, adapted, and tested manually to ensure it meets the project’s functional requirements.
